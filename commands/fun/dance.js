...
module.exports = class Dance extends Base {
        constructor(client) {
            ...
            Object.defineProperty(this, "dance", {
                value: [
            ...
            Object.defineProperty(this, "chosen", {
                value: this.nod[Math.floor(Math.random() * this.dance.length)],
                writable: true
            });
        }
        ...
        run(message) {
            ...
            message.channel.send(`**Dance** ${this.chosen}`); this.chosen = this.dance[Math.floor(Math.random() * this.dance.length)];
            }
        };
